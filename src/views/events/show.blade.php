                        ...
                        <div id="stand-part" class="content col-xs-12 col-sm-12 col-md-6 offset-md-3" role="tabpanel"
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group mb-3">
                                        <label class="form-label fs-6 fw-bolder">{{ trans('entities.stand_type') }}</label>
                                        <select name="stand_type" class="select2 form-select form-select-lg">
                                            <option value="" selected disabled>
                                                {{ trans('forms.select_choice') }}
                                            </option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group mb-3">
                                        <label
                                            class="form-label fs-6 fw-bolder">{{ trans('forms.exhibitor_form.n_modules') }}</label>
